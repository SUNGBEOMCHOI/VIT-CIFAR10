...
from data import get_train_dataset, get_dataloader, get_test_dataset
from utils import loss_func, optim_func, lr_scheduler_func, plot_progress, save_model
...
def train(args, cfg):
    ...
    valid_loader = get_dataloader(valid_dataset, batch_size, shuffle=False)
...
def validation(model, validation_loader, criterion_list, device):
    total_loss = 0.0
